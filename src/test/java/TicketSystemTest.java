...
//    @Test         // cannot run
//    @DisplayName("Test processPayment method with buyDirectTicket method")
//    public void testProcessPaymentMethodWithBuyDirectTicketMethod() throws Exception {
//        ArrayList<Ticket> tickets = new ArrayList<>();
//
//        Ticket validTicket1 = new Ticket(1, 100, flight1, false, false, null);
//        Ticket validTicket2 = new Ticket(2, 123, flight1, true, false, null);
...
//            System.setIn(new ByteArrayInputStream(customerInput.getBytes()));
//            System.err.println("Starting test4");
//            ticketSystem.buyDirectTicket(1);
//            System.err.println("Starting test5");
//            String output = outputStream.toString();
//            assertTrue(output.contains("Ticket purchased successfully!"));        // change to price
//            System.err.println("Starting test6");
//        } finally{
//            System.setOut(originalOutput);
...
//    @Test         // cannot run
//    @DisplayName("Test processPayment method with buyConnectingTickets method")
//    public void testProcessPaymentMethodWithBuyConnectingTicketsMethod() throws Exception {
//        ArrayList<Ticket> tickets = new ArrayList<>();
//
//        Ticket validTicket1 = new Ticket(1, 100, flight1, false, false, null);
//        Ticket validTicket2 = new Ticket(2, 123, flight2, true, false, null);
...
//            System.setIn(new ByteArrayInputStream(customerInput.getBytes()));
//            System.err.println("Starting test4");
//            ticketSystem.buyConnectingTickets(1, 2);
//            System.err.println("Starting test5");
//            String output = outputStream.toString();
//            assertTrue(output.contains("Ticket purchased successfully!"));      // change to price
//            System.err.println("Starting test6");
